            ...
            <section id='experience' className='text-gray-600 body-font'>
                <div className='container px-5 py-24 mx-auto'>
                    <div className='flex flex-col text-center w-full mb-20'>
                        ...
                        <p data-aos='fade-up' data-aos-delay='400' className='lg:w-2/3 mx-auto leading-relaxed text-base'>Here are some of my experiences and projects that I have worked on.</p>
                    </div>
                    <div data-aos='fade-up' data-aos-delay='500' className='flex flex-wrap -m-4 text-center'>
                        ...
                        <div className='p-4 md:w-1/4 sm:w-1/2 w-full'>
                            <div className='border-2 border-blue-200 px-4 py-6 rounded-lg'>
                                <h2 className='title-font font-medium text-3xl text-gray-900'>+1.3k ans</h2>
                                <p className='leading-relaxed'>Client</p>
                            </div>
                        </div>
                        <div className='p-4 md:w-1/4 sm:w-1/2 w-full'>
                            <div className='border-2 border-blue-200 px-4 py-6 rounded-lg'>
                                <h2 className='title-font font-medium text-3xl text-gray-900'>+74 ans</h2>
                                <p className='leading-relaxed'>Comploted project</p>
                            </div>
                        </div>
                        <div className='p-4 md:w-1/4 sm:w-1/2 w-full'>
                            <div className='border-2 border-blue-200 px-4 py-6 rounded-lg'>
                                <h2 className='title-font font-medium text-3xl text-gray-900'>+1.5k ans</h2>
